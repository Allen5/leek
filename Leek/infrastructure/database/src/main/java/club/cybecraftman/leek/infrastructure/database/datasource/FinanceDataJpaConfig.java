...
@EnableJpaRepositories(
        basePackages = "club.cybecraftman.leek.repo.financedata.repository",
...
public class FinanceDataJpaConfig {
    ...
    @ConditionalOnBean(name = {"financeDataDataSource", "financeDataJpaProperties"})
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(@Qualifier("financeDataDataSource") DataSource dataSource,
        ...
        return builder
                ...
                .packages("club.cybecraftman.leek.repo.financedata.model")
    ...
    @ConditionalOnBean(name = "financeDataEntityManagerFactory")
